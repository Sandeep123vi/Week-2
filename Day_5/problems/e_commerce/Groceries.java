...
public class Groceries extends Product {
    ...
    Groceries(String productId, String name, double discountPercent, double taxPercent) {
    ...
    public void getTaxDetails() {
        calculateTax();
        System.out.println("Tax percent on the groceries is " + taxPercent + " and on marked price " + getPrice() + ", it will amount to " + taxAmount);
    }
